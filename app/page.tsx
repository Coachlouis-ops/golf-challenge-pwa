...
<header className="w-full bg-black px-4 py-3 flex flex-col gap-3">
    ...
    <div className="flex items-center gap-3">
      ...
      <a href="https://tiktok.com/teezgolfchallenges" target="_blank">
        <svg width="18" height="18" viewBox="0 0 24 24">
          <path
            fill="#25F4EE"
            d="M9 3v12.5a2.5 2.5 0 1 1-2.5-2.5H8V9H6.5A6.5 6.5 0 1 0 13 15.5V8.5c1.1 1 2.6 1.5 4 1.5V6.5c-1.6 0-3-1.3-3-3H9z"
          />
        </svg>
      </a>
  ...
  <div className="text-center text-[11px] text-gray-400 leading-5">
    <p className="text-white font-semibold">Contact Teez Golf Challenges</p>
          ...
          <div className="grid md:grid-cols-3 gap-12">
            <div className="text-center">
              ...
              <p className="text-gray-400 text-sm">
                Choose your format, set the challenge, and invite your opponents.
              </p>
            </div>

            <div className="text-center">
              <img src="/match_create_1.png" className="w-full mb-4" />
              <h3 className="font-semibold mb-2">
                2. The Battle Commences
              </h3>
              <p className="text-gray-400 text-sm">
                Compete head-to-head, track the match, and let the scoreboard decide.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-400 text-sm">
                Grow your ranking, stats, streaks, match history, and achievements.
              </p>
            </div>
          </div>
        </div>
...
<footer className="bg-gray-100 text-black py-12 px-6">
  <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
    <div className="text-center md:text-left space-y-2">
      ...
      {/* CONTACT DETAILS (ADDED) */}
      <div className="text-xs text-gray-600 leading-5 mt-2">
    ...
    <div className="flex items-center gap-4">
      ...
      >
        <svg width="20" height="20" viewBox="0 0 24 24">
          ...
          <path
            fill="url(#ig)"
            d="M7 2C4.2 2 2 4.2 2 7v10c0 2.8 2.2 5 5 5h10c2.8 0 5-2.2 5-5V7c0-2.8-2.2-5-5-5H7zm5 4.8A5.2 5.2 0 1 1 6.8 12 5.2 5.2 0 0 1 12 6.8zm6.5-.3a1.2 1.2 0 1 1-1.2-1.2 1.2 1.2 0 0 1 1.2 1.2zM12 9.3A2.7 2.7 0 1 0 14.7 12 2.7 2.7 0 0 0 12 9.3z"
          />
        </svg>
      </a>
