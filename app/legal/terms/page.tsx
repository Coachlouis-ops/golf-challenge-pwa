    ...
    <main className="bg-black text-white px-6 md:px-16 py-16">
      ...
      <div className="space-y-6 text-sm text-gray-300 max-w-4xl">
        <p>
          ...
          (Registration Number: 2026/102722/07), a private company based in
          South Africa.
        </p>
        ...
        <p>
          Honey Badger Technologies (PTY) LTD is a business in the digital
          services industry that offers access to online platforms, including
        ...
        <p>
          Honey Badger Technologies (PTY) LTD does not sell personal information
          to third parties.
        </p>
        ...
        <p>
          All payment amounts are displayed before payment is completed. Users
          are responsible for ensuring that the correct payment amount and
        ...
        <p>
          The merchant outlet country at the time of presenting payment options
          to the customer is South Africa. Transaction currency is South African
          Rand (ZAR).
        </p>
        ...
        <p>
          Teez Golf Challenges is a skill-based golf competition platform.
          Competitions are based on golf performance, scoring, player skill, and
          competition rules.
        </p>
        ...
        <p>
          Nothing in these Terms is intended to remove or reduce any rights that
        ...
        <p>
          These Terms are governed by the laws of South Africa. User rights will
          be handled in accordance with applicable South African law, including
        ...
        <p>
          Honey Badger Technologies (PTY) LTD reserves the right to investigate
          suspected misuse and to take appropriate action to protect the
        ...
        <p>
          ...
          platform availability, but does not guarantee uninterrupted access,
        ...
        <p>
          To the maximum extent permitted by law, Honey Badger Technologies
          (PTY) LTD and Teez Golf Challenges shall not be liable for any direct,
          indirect, incidental, or consequential damages arising from use of the
          platform, except where liability cannot be excluded under applicable
          South African law.
        </p>
        ...
        <p>
          All platform content, systems, software, designs, competition systems,
          branding, logos, and related intellectual property remain the property
        ...
        <p>
          ...
          Technologies (PTY) LTD chooses as its domicilium citandi et executandi
        ...
        <p>
          ...
          these Terms or any part thereof at any time. Continued use of the
        ...
        <p>
          ...
          as Honey Badger Technologies (PTY) LTD.
        </p>
