  ...
  return (
    <RequireAuth>
      <main className="relative min-h-screen bg-black text-white overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col px-4 pt-16 pb-10 gap-6 max-w-2xl mx-auto w-full">
          ...
          <div className="flex flex-col gap-4">
            {challenges.map((challenge) => (
              <button
                ...
                className="w-full p-4 bg-[#111] rounded-2xl text-left transition-all shadow-[0_0_15px_rgba(255,0,0,0.15)] hover:shadow-[0_0_25px_rgba(255,0,0,0.35)]"
              >
                <div className="flex flex-col gap-1">
          ...
          <button
            ...
            className="w-full py-4 rounded-2xl bg-[#ff0000] text-black font-semibold shadow-[0_0_15px_#ff0000]"
          >
