...
export default function GoldVaultPage() {
  ...
  const loadGoldVault = useCallback(async () => {
    if (!user) return;
  ...
  async function flipCoin(
    ...
    try {
      const openGoldVaultCoin = httpsCallable<
        { coinNumber: number },
        {
          success: boolean;
          coin: CoinResult;
      ...
      console.error(
        "Unable to open Gold Vault coin:",
        error
      );
    ...
    return (
      <main className="flex min-h-screen items-center justify-center bg-[#eef1f4] px-6">
        <div className="border border-slate-200 bg-white px-8 py-6 text-center shadow-sm">
          <div className="mx-auto h-8 w-8 animate-spin rounded-full border-2 border-slate-200 border-t-[#9a7531]" />
    ...
    <main className="min-h-screen bg-[#eef1f4] text-[#111827]">
      <div className="mx-auto max-w-md pb-14">
        ...
        <header className="sticky top-0 z-30 border-b border-slate-200 bg-white/95 px-5 py-4 backdrop-blur">
          <div className="flex items-center justify-between">
            ...
            <div className="text-center">
              <p className="text-[10px] font-bold uppercase tracking-[0.26em] text-[#9a7531]">
                TEEZ Player Vault
              </p>
        ...
        <div className="space-y-7 px-4 pt-5">
          ...
          <section className="overflow-hidden border border-[#9a7531] bg-[#18160f] shadow-[0_8px_22px_rgba(15,23,42,0.16)]">

            <div className="flex items-start gap-4 border-b border-white/10 p-5">

              <div className="flex h-16 w-16 shrink-0 items-center justify-center border border-[#c9b37a] bg-[#2a2518]">
              ...
              <div>
                <p className="text-[10px] font-bold uppercase tracking-[0.22em] text-[#c9b37a]">
                  Vault Series 03
                </p>
                ...
                <p className="mt-2 text-sm leading-5 text-slate-300">
                  Gold introduces premium career rewards
                  and stronger Race to Final bonuses.
                </p>
              </div>
            </div>
            ...
            <div className="border-t border-white/10 px-5 py-4">
              <div className="flex items-center justify-between">
                ...
                <p className="text-xs font-black text-[#d6bd7a]">
                  {openedCount} / 50
                </p>
              </div>
          ...
          <section className="border border-[#c9b37a] bg-[#faf7ef] px-5 py-4">
            ...
            <h3 className="mt-1 text-base font-black">
              Enhanced Race to Final Rewards
            </h3>

            <p className="mt-1 text-xs leading-5 text-slate-500">
              Gold mystery coins can award 25, 50 or
              75 bonus Race Points toward your season total.
            </p>
          </section>
          ...
          <section>
            <SectionHeading
              eyebrow="GOLD SERIES · COINS 101–150"
              title="Select a Mystery Coin"
              description="Gold coins contain premium career rewards and enhanced Race to Final bonuses"
            />

            <div className="border border-[#c9b37a] bg-[#faf8f2] p-4 shadow-sm">

              <div className="mb-4 flex items-center justify-between border-b border-[#e3d7b7] pb-3">
                <p className="text-[9px] font-black uppercase tracking-[0.14em] text-[#9a7531]">
                  Official Coin Board
                </p>
            ...
            <section className="overflow-hidden border border-[#c9b37a] bg-white shadow-sm">
              <div className="p-5">
                ...
                <h2 className="mt-1 text-xl font-black">
                  Gold Series Complete
                </h2>

                <p className="mt-2 text-sm leading-5 text-slate-500">
                  All 50 Gold mystery coins have been
                  opened. Diamond Vault is now available.
                </p>
              </div>
...
function SectionHeading({
  ...
  return (
    <div className="mb-3">
      <div className="mb-2 h-[2px] w-8 bg-[#9a7531]" />

      <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-[#9a7531]">
        {eyebrow}
      </p>
    ...
    <button
      ...
      className={`relative aspect-square rounded-full border text-[9px] font-black ${
        opened
          ...
          : opening
            ? "animate-[spin_0.7s_linear_infinite] border-[#c9b37a] bg-[#d6bd7a] text-white"
            : disabled
              ? "cursor-not-allowed border-slate-300 bg-slate-200 text-slate-400"
              : "border-[#9a7531] bg-[#b08a42] text-white shadow-[inset_0_0_0_2px_rgba(255,255,255,0.18),0_2px_4px_rgba(60,45,10,0.18)] active:scale-95"
      }`}
    >
      {opened ? (
...
function CoinRevealModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#07100c]/90 px-6 backdrop-blur-sm">
      <div className="w-full max-w-sm overflow-hidden border border-[#c9b37a] bg-white shadow-[0_24px_70px_rgba(0,0,0,0.4)]">

        <div className="bg-[#18160f] px-6 py-5 text-center">
          <p className="text-[9px] font-black uppercase tracking-[0.22em] text-[#d6bd7a]">
            Gold Vault · Coin {coin.coinNumber}
          </p>
        ...
        <div className="px-6 py-7 text-center">
          ...
          <div className="mx-auto flex h-24 w-24 items-center justify-center rounded-full border-2 border-[#c9b37a] bg-[#faf7ef]">
            <span
              className={`font-black ${
                isRaceReward
                  ? "text-lg text-[#9a7531]"
                  : "text-3xl text-[#9a7531]"
              }`}
            >
              {coin.rewardIcon}
            </span>
          ...
          <p className="mt-6 text-[9px] font-black uppercase tracking-[0.18em] text-[#9a7531]">
            {isRaceReward
              ? "Race to Final Bonus"
              : "Gold Player Reward"}
          </p>
